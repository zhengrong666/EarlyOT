...
package top_earlgrey_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopEarlgreyAlertIdRotTopRecovCtrlUpdateErr = 63,
    TopEarlgreyAlertIdRotTopFatalFaultAes = 64,
    TopEarlgreyAlertIdRotTopFatalOtbn = 65,
    TopEarlgreyAlertIdRotTopRecovOtbn = 66,
    TopEarlgreyAlertIdCsrngRecovAlert = 67,
    TopEarlgreyAlertIdCsrngFatalAlert = 68,
    TopEarlgreyAlertIdEntropySrcRecovAlert = 69,
    TopEarlgreyAlertIdEntropySrcFatalAlert = 70,
    TopEarlgreyAlertIdEdn0RecovAlert = 71,
    TopEarlgreyAlertIdEdn0FatalAlert = 72,
    TopEarlgreyAlertIdEdn1RecovAlert = 73,
    TopEarlgreyAlertIdEdn1FatalAlert = 74,
    TopEarlgreyAlertIdSramCtrlMainFatalError = 75,
    TopEarlgreyAlertIdRomCtrlFatal = 76,
    TopEarlgreyAlertIdRvCoreIbexFatalSwErr = 77,
    TopEarlgreyAlertIdRvCoreIbexRecovSwErr = 78,
    TopEarlgreyAlertIdRvCoreIbexFatalHwErr = 79,
    TopEarlgreyAlertIdRvCoreIbexRecovHwErr = 80,
