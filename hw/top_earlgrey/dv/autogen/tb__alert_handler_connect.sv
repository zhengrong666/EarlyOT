...
assign alert_if[63].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[0];
assign alert_if[64].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[1];
assign alert_if[65].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[0];
assign alert_if[66].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[1];
assign alert_if[67].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[0];
assign alert_if[68].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[1];
assign alert_if[69].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[0];
assign alert_if[70].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[1];
assign alert_if[71].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[0];
assign alert_if[72].alert_tx = `CHIP_HIER.u_rom_ctrl.alert_tx_o[0];
assign alert_if[73].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[0];
assign alert_if[74].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[1];
assign alert_if[75].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[2];
assign alert_if[76].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[3];
