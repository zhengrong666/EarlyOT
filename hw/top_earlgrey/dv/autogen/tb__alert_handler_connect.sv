...
assign alert_if[51].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[0];
assign alert_if[52].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[1];
assign alert_if[53].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[2];
assign alert_if[54].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[3];
assign alert_if[55].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[4];
assign alert_if[56].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[5];
assign alert_if[57].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[6];
assign alert_if[58].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[7];
assign alert_if[59].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[8];
assign alert_if[60].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[9];
assign alert_if[61].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[10];
assign alert_if[62].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[11];
assign alert_if[63].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[12];
assign alert_if[64].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[13];
assign alert_if[65].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[14];
assign alert_if[66].alert_tx = `CHIP_HIER.u_rot_top.alert_tx_o[15];
assign alert_if[67].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[0];
assign alert_if[68].alert_tx = `CHIP_HIER.u_csrng.alert_tx_o[1];
assign alert_if[69].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[0];
assign alert_if[70].alert_tx = `CHIP_HIER.u_entropy_src.alert_tx_o[1];
assign alert_if[71].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[0];
assign alert_if[72].alert_tx = `CHIP_HIER.u_edn0.alert_tx_o[1];
assign alert_if[73].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[0];
assign alert_if[74].alert_tx = `CHIP_HIER.u_edn1.alert_tx_o[1];
assign alert_if[75].alert_tx = `CHIP_HIER.u_sram_ctrl_main.alert_tx_o[0];
assign alert_if[76].alert_tx = `CHIP_HIER.u_rom_ctrl.alert_tx_o[0];
assign alert_if[77].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[0];
assign alert_if[78].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[1];
assign alert_if[79].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[2];
assign alert_if[80].alert_tx = `CHIP_HIER.u_rv_core_ibex.alert_tx_o[3];
